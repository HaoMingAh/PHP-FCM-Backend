		...
		<div class="box">
			<?php if($show_add){ ?>
				<div class="box-header">
					<a href="<?= site_url('Admin/tickets_add') ?>" class="btn btn-success" data-toggle="modal"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add New Ticket</a>
				</div>
			<?php } ?>
			<!-- /.box-header -->
			<div class="box-body">
				<table id="mytickets" class="table table-bordered table-striped text-center">
					<thead>
					<tr>
						<th>No</th>
						<th>User</th>
...
<script>
	$(document).ready(function(){
		...
		$('#mytickets_filter').css('text-align','right');
		
		var delete_url = '<?= site_url('Admin/tickets_delete') ?>';
