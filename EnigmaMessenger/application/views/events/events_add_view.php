  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
	  ...
	  <ol class="breadcrumb">
		...
		<li><a href="#"><i class="fa fa-plus"></i> Add Events</a></li>
	  </ol>
	</section>
		...
		<div class="box">
			 <div class="box-body">
				...
				<div class="modal-body">
					<form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= site_url('Admin/events_create')?>" >
						<div class="box-body">
							<div class="form-group">
								<label for="name" class="col-sm-2 control-label">Event Name</label>
								<div class="col-sm-10">
									<input type="text" value="" class="form-control" name="event_name" placeholder="Name" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select class="form-control eventtype" name="event_type" required>
											...
											<option value="1" >Pirates</option>
											<option value="0" >MCP</option>
									</select>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select class="form-control clubs" name="club_id" required>
										<?php foreach($clubs as $x){ ?>
											<option value="<?=$x->id;?>" class="<?php if($x->id ==1 || $x->id == 2){echo "type2";}else{echo "type1";}?>" ><?=$x->name;?></option>
										<?php }?>
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" value="00:00:00" name="start_time" placeholder="Start Time" required>
								</div>
							</div>
							<div class="form-group">
								<label for="end_time" class="col-sm-2 control-label">End Time</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" value="00:00:00" name="end_time" placeholder="end Time" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea class="form-control" name="music" placeholder="Music"></textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select class="form-control" name="entry_type" required>
										...
										<option value="Pirates Reloaded">Pirates Reloaded</option>
									</select>
								</div>
							</div>
						</div>
						...
						<div class="box-footer">
							...
							<input type="submit" value="Add Event" class="btn btn-success formSubmit">
						</div>
						<!-- /.box-footer -->
					</form>
				</div>
